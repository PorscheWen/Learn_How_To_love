...
Demo 優先使用本資料夾的 **OGG 循環曲**；若檔案缺失則自動退回 `js/audio.js` 程序化暖色 pad。
...
> Music: "Peaceful Intro" by Eric Matyas (soundimage.org); "Peace at last" by bart; "Thoughtful Piano Theme" by Trinnox; "Emotional Piano" by Centurion_of_war — via OpenGameArt.org
