...
const ALBUM_ENTRIES = {
  prologue_rain: { day: 1, title: '雨天相遇', desc: '紙箱裡的第一次對視。' },
  first_night: { day: 1, title: '第一夜', desc: '吹乾、哀鳴、和三步外的陪伴。' },
  day2_petshop: { day: 2, title: '寵物店', desc: '風鈴響了一下，阿姨教了你很多事。' },
  dog_named: { day: 2, title: '取名', desc: '你念起來會溫柔的那一個字。' },
  day2_first_meal: { day: 2, title: '第一次自己吃', desc: '你退開，牠才肯靠近碗。' },
  door_wait: { day: 3, title: '門口的等待', desc: '你提早回家，牠趴在玄關。' },
  potty_guide: { day: 3, title: '如廁暗號', desc: '對的瞬間，牠終於聽懂了。' },
  potty_night: { day: 3, title: '尿墊之夜', desc: '你沒有罵，清理完，陪牠坐在旁邊。' },
  knee: { day: 3, title: '靠膝', desc: '牠把頭輕靠在你膝上。' },
  vet_visit: { day: 4, title: '寵物醫院', desc: '週六的健康檢查，和第一筆很認真的帳。' },
  home_scent: { day: 5, title: '家的氣味', desc: '週日繞一圈，牠記住了這裡。' },
  thunder: { day: 6, title: '雷雨', desc: '你開了小燈，陪牠慢慢不怕。' },
  sad_day: { day: 7, title: '你難過的那一天', desc: '你難過時，牠只是靠過來。' },
  balcony_sun: { day: 3, title: '陽台上的風', desc: '一起曬過一次太陽。' },
  walk_calm: { day: 5, title: '散步的節奏', desc: '回頭時你都在，步子漸漸穩了。' },
  park_tree: { day: 5, title: '第一次聞樹', desc: '公園裡，牠把鼻子埋進泥土。' },
  follow_foot: { day: 5, title: '第一次跟腳', desc: '回家路上，牠走在你腳邊，一步也不願離太遠。' },
};
