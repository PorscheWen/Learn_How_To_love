...
description: >-
  規劃與審查《Learn How to Love／學會去愛》遊戲美術：水彩狗角色 PNG、背景場景、色溫 UI、沉浸式 Demo 版面（70/30 全屏舞台）、三部曲視覺一致性。
  當使用者要新增 dog pose、情緒圖、背景 art、角色外型、主人／狗一致性、CSS 場景、調整畫面布局、去背流程、aging 變體，或審查美術／版面是否偏離 guide_line §6.6 與 Demo 基準時，務必使用此 skill。
---
